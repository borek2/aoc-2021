...
class Day5(): Day<List<Pair<Pair<Int, Int>, Pair<Int, Int>>>> {

    override lateinit var data: List<Pair<Pair<Int, Int>, Pair<Int, Int>>>

    constructor(context: Context) : this() {
        data = InputReader()
            .read(context.assets, "day5") { line -> parseLine(line) }
    }

    constructor(data: List<String>) : this() {
        this.data = data.map { line -> parseLine(line) }
    }
